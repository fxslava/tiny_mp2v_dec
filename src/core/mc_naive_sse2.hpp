...
MP2V_INLINE void pred_mc8_template_nsse2(uint8_t* dst, uint8_t* src, uint32_t stride, int height)
{
    for (int j = 0; j < height; j += 4) {
        _mm_storel_epi64((__m128i*)dst, mc8_func_template_nsse2<mc_type>(src, stride)); src += stride; dst += stride;
        _mm_storel_epi64((__m128i*)dst, mc8_func_template_nsse2<mc_type>(src, stride)); src += stride; dst += stride;
        _mm_storel_epi64((__m128i*)dst, mc8_func_template_nsse2<mc_type>(src, stride)); src += stride; dst += stride;
        _mm_storel_epi64((__m128i*)dst, mc8_func_template_nsse2<mc_type>(src, stride)); src += stride; dst += stride;
    }
...
template<mc_type_e mc_type_src0, mc_type_e mc_type_src1>
MP2V_INLINE void bidir_mc8_line_template_nsse2(uint8_t*& dst, uint8_t*& src0, uint8_t*& src1, uint32_t stride) {
...
{
    for (int j = 0; j < height; j += 4) {
        bidir_mc8_line_template_nsse2<mc_type_src0, mc_type_src1>(dst, src0, src1, stride);
        bidir_mc8_line_template_nsse2<mc_type_src0, mc_type_src1>(dst, src0, src1, stride);
        bidir_mc8_line_template_nsse2<mc_type_src0, mc_type_src1>(dst, src0, src1, stride);
        bidir_mc8_line_template_nsse2<mc_type_src0, mc_type_src1>(dst, src0, src1, stride);
    }
